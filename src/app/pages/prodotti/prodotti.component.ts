...
export class ProdottiComponent implements OnInit {
  ...
  getElementCarrello() {
    if(window.localStorage.getItem("carrello") != undefined){//controllo che il carrello non sia vuoto
      this.elementiCarrello = JSON.parse(window.localStorage.getItem("carrello"));
    }
  }
  ...
  async myLazyLoad() {
    ...
    this.prodottiService.getProdottiPagination(this.index, this.elPerPage).subscribe((res) => {
